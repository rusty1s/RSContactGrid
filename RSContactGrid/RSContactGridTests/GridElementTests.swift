...
class GridElementTests: XCTestCase {
    ...
    func testRotatedSquareElement() {
        ...
        let element4 = RotatedSquareElement<String, String>(x: -2, y: -2)
        XCTAssertEqual(element4.x, -2)
        XCTAssertEqual(element4.y, -2)
        XCTAssertEqual(element4.frame, CGRect(x: -40, y: -20, width: 20, height: 20))
        XCTAssertEqual(element4.center, CGPoint(x: -30, y: -10))
        XCTAssertEqual(element4.vertices.count, 4)
        XCTAssertEqual(element4.vertices, [CGPoint(x: -40, y: -10), CGPoint(x: -30, y: 0), CGPoint(x: -20, y: -10), CGPoint(x: -30, y: -20)])
    ...
    func testHexagonalElement() {
        ...
        let element4 = HexagonalElement<String, String>(x: -1, y: 0)
        XCTAssertEqual(element4.x, -1)
        XCTAssertEqual(element4.y, 0)
        XCTAssertEqual(element4.frame, CGRect(x: -30, y: 0, width: 20, height: 20))
        XCTAssertEqual(element4.center, CGPoint(x: -20, y: 10))
        XCTAssertEqual(element4.vertices.count, 6)
        XCTAssertEqual(element4.vertices, [CGPoint(x: -30, y: 10), CGPoint(x: -25, y: 20), CGPoint(x: -15, y: 20), CGPoint(x: -10, y: 10), CGPoint(x: -15, y: 0), CGPoint(x: -25, y: 0)])
        
        let element5 = HexagonalElement<String, String>(x: -1, y: -1)
        XCTAssertEqual(element5.x, -1)
        XCTAssertEqual(element5.y, -1)
        XCTAssertEqual(element5.frame, CGRect(x: -15, y: -10, width: 20, height: 20))
        XCTAssertEqual(element5.center, CGPoint(x: -5, y: 0))
        XCTAssertEqual(element5.vertices.count, 6)
        XCTAssertEqual(element5.vertices, [CGPoint(x: -15, y: 0), CGPoint(x: -10, y: 10), CGPoint(x: 0, y: 10), CGPoint(x: 5, y: 0), CGPoint(x: 0, y: -10), CGPoint(x: -10, y: -10)])
        
        let element6 = HexagonalElement<String, String>(x: -2, y: -2)
        XCTAssertEqual(element6.x, -2)
        XCTAssertEqual(element6.y, -2)
        XCTAssertEqual(element6.frame, CGRect(x: -60, y: -20, width: 20, height: 20))
        XCTAssertEqual(element6.center, CGPoint(x: -50, y: -10))
        XCTAssertEqual(element6.vertices.count, 6)
        XCTAssertEqual(element6.vertices, [CGPoint(x: -60, y: -10), CGPoint(x: -55, y: 0), CGPoint(x: -45, y: 0), CGPoint(x: -40, y: -10), CGPoint(x: -45, y: -20), CGPoint(x: -55, y: -20)])
