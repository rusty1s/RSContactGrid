...
class GridElementTests: XCTestCase {
    ...
    func testSquareElement() {
        var element1 = SquareElement(x: 0, y: 0)
        ...
        XCTAssertEqual(element1.content as! String, "content")
        element1.contact = "contact"
        XCTAssertNotNil(element1.contact)
        XCTAssertEqual(element1.contact as! String, "contact")
        ...
        let element2 = SquareElement(x: 2, y: 2, content: "content", contact: "contact")
        XCTAssertEqual(element2.x, 2)
        XCTAssertEqual(element2.y, 2)
        XCTAssertNotNil(element2.content)
        XCTAssertEqual(element2.content as! String, "content")
        XCTAssertNotNil(element2.contact)
        XCTAssertEqual(element2.contact as! String, "contact")
